...
function Nav() {
    ...
    return (
        ...
        <div className="w-full min-h-16 md:h-20 flex items-center bg-[url(https://static.wixstatic.com/media/c837a6_35bdfabce3724dad92a9f8828437078e~mv2.jpeg)] bg-cover">

            {/* container */}
            <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 flex items-center justify-between text-xl">
