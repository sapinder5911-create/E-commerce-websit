...
return (
    ...
    bg-[url(https://static.wixstatic.com/media/c837a6_35bdfabce3724dad92a9f8828437078e~mv2.jpeg/v1/fill/w_1873,h_945,fp_0.50_0.50,q_85,usm_0.66_1.00_0.01,enc_auto/84770f_85e5f4e9599f470cb22efaa7e0cf7d8f~mv2.jpeg)] bg-cover bg-center">

        <div className="h-20 w-full max-w-7xl px-4 flex items-center justify-between text-xl">

            {/* LEFT */}
            <div className="flex items-center gap-6">

                <a href="" id="hello" className="text-white font-bold">
                    🌿Plants
                </a>
                ...
                <div className="hidden md:flex gap-6 text-white">
                    ...
                    <Link to="/about" id="hello"
                        className="text-green-400 hover:text-green-600">
                        About
                    </Link>

                    <Link to="/shop" id="hello"
                            ...
                            <ul className="menu bg-base-200 min-h-full w-80 sm:w-96 p-4">
                                ...
                                {items.length === 0 ? (
                                    ...
                                    items.map((item) => (
                                        <div
                                            key={item._id}
                                            className="flex gap-4 mt-4 text-black"
                                        >
